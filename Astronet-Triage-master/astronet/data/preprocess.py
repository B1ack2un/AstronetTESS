...
def read_and_process_light_curve(tic, tess_data_dir, sector=43, injected=False, inject_dir='/pdo/users/yuliang', is_multi=False):
  ...
  all_time, all_mag = tess_io.read_tess_light_curve(file_names, invert=True)
