...
Telescopes (MAST) at:
  ...
  http://archive.stsci.edu/pub/tess/lightcurves.
...
where:
  tess_id is the TESS id left-padded with zeros to length 16;
...
def make_eval_set(argv):
    ...
    boundaries = np.linspace(0, len(tce_table),
                           FLAGS.num_train_shards + 1).astype(np.int64)
